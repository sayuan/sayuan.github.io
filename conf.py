...
BLOG_AUTHOR = "Shiao-An Yuan"  # (translatable)
...
BLOG_EMAIL = "shiao.an.yuan@gmail.com"
BLOG_DESCRIPTION = "Shiao-An Yuan personal blog"  # (translatable)
...
# is in the manual.
#COMMENT_SYSTEM_ID = "say-something"
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-47613541-1"></script>
<script>
  cjkSpaceFix();
